...
window.RenderService = (function () {
  ...
  function setBoundaryNotice() {
    ...
    container.innerHTML =
      ...
      "<ul>" +
      "<li>泰安市义务教育入学服务平台致力于为家长提供便捷的入学信息查询服务。</li>" +
      "<li>平台整合了泰安市学区划分、招生政策、入学材料与常见问题等信息。</li>" +
      "<li>地图数据基于泰安市实际地理信息，为家长提供直观的学区查询体验。</li>" +
      "<li>如有疑问，请咨询当地教育主管部门获取权威信息。</li>" +
      "<li>本平台定期更新数据，确保信息的准确性和时效性。</li>" +
      "</ul>" +
      "</div>";
  }
